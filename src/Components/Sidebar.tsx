...
import { FiHome, FiHardDrive, FiDatabase, FiGlobe, FiFolder, FiLogOut } from 'react-icons/fi';
...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-64 bg-white p-6 h-screen hidden md:flex flex-col justify-between border-r shadow-lg">
      {/* Logo */}
      <div>
        <h2 className="text-2xl font-bold text-gray-800 mb-10 tracking-tight">AcceleronLabs</h2>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-3 px-4 py-2 rounded-lg transition-all duration-200 font-medium text-gray-700 hover:bg-gray-100 ${
                  isActive ? 'bg-gray-100 border-l-4 border-blue-600 pl-3 text-blue-600' : ''
                }`
              }
            >
